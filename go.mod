module github.com/adrianbrad/psql-docker-tests-example

go 1.17

require (
	github.com/adrianbrad/psqldocker v0.0.0-20220411175546-15466840370e
	github.com/adrianbrad/psqltest v0.0.0-20220411180417-01ee59cbc76c
